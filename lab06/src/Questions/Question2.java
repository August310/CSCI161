...
=======
        if (outcome == true) {
            money += wager;
            System.out.println("I've won a " + nf.format(wager) + " wager and now have " + nf.format(money) + "!");
        }
...
>>>>>>> .r2653
		...
		*			where $wager and $money are the values of the wager and how much money the gambler now has respectively.
        ...
        if (outcome == false) {
            money -= wager;
            System.out.println("I've lost a " + nf.format(wager) + " wager and now have " + nf.format(money) + "!");
        }

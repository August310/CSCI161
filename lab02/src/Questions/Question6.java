...
int num1 = rand.nextInt(0,20+1);
     ...
     */
int num2 = rand.nextInt(33-17+1)+17;
...
int num3 = rand.nextInt(-15, 15+1);
     ...
     */
int num4 = randInt.nextInt(100-0+1)+0;
     ...
     */
int num5 = randInt.nextInt(100000)+1;

...
public class Question2 {
    ...
    *   Object array that will be returned by the method.
    ...
    public Object[] Question2() {
        ...
        int[][] numberOfDowns = new int[111][11];
         ...
         */
        double[][] snowfallAverages = new double[100][7];
         ...
         */
        int[][][] iceCreamSales = new int[3][52][17];
         ...
         */
        String[][] newIdentities = new String[3][365];
         ...
         */
        double[][][][][] groceryStoreSales = new double[10][52][7][10][12];
         ...
         */
        Object[] combinationArray = {numberOfDowns, snowfallAverages, iceCreamSales, newIdentities, groceryStoreSales};

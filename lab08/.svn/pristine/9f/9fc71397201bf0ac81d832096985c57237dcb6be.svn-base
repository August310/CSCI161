...
public class Question3 {
    ...
    public static int[][] multiplicationTable(int maxNumber) {
        ...
        int[][] multiplies = new int[maxNumber + 1][maxNumber + 1];
        for (int i = 0; i < multiplies.length; i++) {

            for (int j = 0; j < multiplies[i].length; j++) {
    ...
    public static ArrayList partyList() {
        ...
        ArrayList<Person> guests = new ArrayList<>(3);
    ...
    public static ArrayList combinedList(ArrayList<Person> yourGuestList, ArrayList<Person> friendsGuestList, ArrayList<Person> cannotAttend) {
         ...
         */
        for (Person myList : yourGuestList) {
            masterGuestList.add(myList);
        }
         ...
         */
        masterGuestList.addAll(friendsGuestList);
